...
local SkillCache  = {}   -- key = fruit|skill (กันดักซ้ำ)
local ToggleCache = {}   -- [skill] = true (กันสร้าง Toggle ซ้ำ)
local Toggles = {}
...
-- 🔄 Refresh: เพิ่มเฉพาะ Toggle ใหม่ (ไม่ลบของเดิม)
Tab:CreateButton({
    Name = "🔄 รีเฟรชสกิว",
    Callback = function()
